...
namespace InvEXE
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("make sure Inventor is Open");
                return;
            }
    ...
    public class Macros
    {
        ...
        public void CreateiMateDefinition()
        {
         ...
         PartDocument oPartDoc  = (PartDocument)_invApp.Documents.Add(DocumentTypeEnum.kPartDocumentObject, _invApp.FileManager.GetTemplateFile(DocumentTypeEnum.kPartDocumentObject));
        ...
        public void iMateResultCreation()
        {
         ...
         AssemblyDocument oAssDoc = (AssemblyDocument)_invApp.ActiveDocument;
         ...
         oMatrix = _invApp.TransientGeometry.CreateMatrix();
        ...
        public void BOMfromLoD()
        {
            ...
            AssemblyDocument oAsmDocMasterLOD = (AssemblyDocument)_invApp.Documents.Open(oAsmDoc.File.FullFileName, false);
